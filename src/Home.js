        ...
        <div className="overlay">
          <div class="container ">
              ...
              <div class="col-md-8">
                <div class="p-3  margin1">
                  ...
                  <p className="mainpara mt-4">
                    ...
                    feature and more to ensure the sustainability and longevity
                    of the project.
                  </p>
                  <p className="mainpara">
                    Hire Aliens, so they will immediately start building your
                    city to generate crazy daily returns on your investment.
                  </p>
                  <br />
                  <button
                    type="button"
                      ...
                      >
                        ...
                        <div class="modal-body">
                          ...
                          <p className="mt-3">
                            ...
                            details about rewards, game play and the link. You
                            can also add your referral link in your post. Post
                            as many times to increase your chance to win the
                            pool. Quality of the post and also the number of
                            people it reaches will matter in deciding the
                            winners. <br />
                            <br />
            ...
            <div className="row ">
              ...
              >
                High Risk! Funds that are used to initially hire aliens
                (including re-hire) cannot be withdrawn, however your alien will
                indefinitely work and build cities for you. Please play the game
